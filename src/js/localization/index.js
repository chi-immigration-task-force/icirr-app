...
const strings = new LocalizedStrings({
  ...
  es: {
    ...
    discover: {
      ...
      infoHeader: 'Estoy buscando información sobre...',
      orgHeader: 'Necesito que alguien me ayude en...',
      items: {
        [servicesConstants.hasNaturalizationClasses]: 'Aprobar la entrevista de ciudadanía',
        [servicesConstants.hasLegalAid]: 'Solicitar la ciudadanía estadounidense',
        [servicesConstants.hasOutreachAndEducation]: 'Encontrar mayor información',
        kyr: 'Mis derechos',
        ...
        feeWaiverCalculator: 'Solicitando la gratuidad del proceso de ciudadanía',
      },
    },
    kyr: {
      content: kyrSpanish,
